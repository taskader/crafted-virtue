...
const FEATURES: { name: string; body: string; icon: FeatureIconName; illus: IllustrationName }[] = [
  ...
  { name: "Publishing Calendar",              body: "Plan and schedule approved posts across connected channels. Use unified social publishing connections for LinkedIn, X, Instagram, Facebook, YouTube, TikTok, Blog, and Newsletter.", icon: "publishingCalendar",  illus: "publishing" },
