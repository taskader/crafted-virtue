...
const SCHEDULED: TimelinePost[] = [
  ...
  // ---- May 19 ----
  {
    ...
    content:
      "Reputation does not spike. It compounds.\n\nThree things I have learned about earning trust slowly — and why most operators give up six months too early.",
    createdByAgent: "Sam",
  ...
  },
  {
    ...
    status: "scheduled",
    date: "2026-05-20",
    scheduledAt: "Wed May 20 · 06:00",
    authorName: author.name,
    authorHandle: "ellisharrow.com",
    title: "The Quiet Compounding of Reputation",
    excerpt:
      "Why the most important work on your calendar is the work no one applauds in the moment.",
    content:
      "Reputation does not spike. It accumulates. It does not shout. It becomes recognizable. It does not chase attention — it earns trust in the rooms where decisions are made.",
    ...
    voiceScore: 93,
    factCheckStatus: "verified",
    metrics: { views: 0, shares: 0, saves: 0 },
  },
  {
    id: "s4",
    platform: "instagram",
